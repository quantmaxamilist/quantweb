  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
      <svg width="40" height="32" viewBox="0 0 40 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M22 10 L25.5 22 L29 15 L32.5 22 L36 10" stroke="#1d1d1f" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
      </svg>
      <span style={{ fontSize: '16px', fontWeight: '700', letterSpacing: '-0.4px' }}>
        <span style={{ color: '#1d1d1f' }}>Quant</span><span style={{ color: '#0071e3' }}>Web</span>
      </span>
    </div>
  )
}
